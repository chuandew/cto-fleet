...
<!-- Protocol sections (preamble, handoff, consensus, error-handling) are auto-injected by bin/sync-protocols -->
<!-- Run: bin/sync-protocols --fix after creating this skill -->
